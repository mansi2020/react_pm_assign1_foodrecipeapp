...
import {FETCH_CATEGORY_BEGIN,FETCH_CATEGORY_SUCCESS,FETCH_CATEGORY_ERROR,FETCH_MEALS_BEGIN,FETCH_MEALS_SUCCESS,FETCH_MEALS_ERROR,FETCH_CATEGORY_MEALS_ERROR,FETCH_CATEGORY_MEALS_SUCCESS,FETCH_CATEGORY_MEALS_BEGIN,FETCH_SINGLE_MEAL_BEGIN,FETCH_SINGLE_MEAL_SUCCESS,FETCH_SINGLE_MEAL_ERROR} from "./../actions/actions"
...
export const mealReducer = (state,action)=>{
    switch(action.type){
        ...
        case FETCH_CATEGORY_SUCCESS:
            console.log("Categories data:", action.payload);
            return {
                ...state,
